...
initialization
  ...
  TTimeOfDayDataFormat.RegisterCompatibleFormat(TTimeOfDayClipboardFormat, 0,
    csSourceTarget, [ddRead]);

finalization
  // Data format unregistration
  TTimeOfDayDataFormat.UnregisterDataFormat;
  // Clipboard format unregistration
  TTimeOfDayClipboardFormat.UnregisterClipboardFormat;
end.
